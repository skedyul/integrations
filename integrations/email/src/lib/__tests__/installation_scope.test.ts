...
describe('withInstallationScope', () => {
  ...
  // Regression: receive_email is provision-scoped and must exchange before file.upload.
  // Installation-scoped invocations already hold sk_wkp_*, and Core rejects token.exchange
  // for those. Exchanging here broke inbound SMS in phone; skip the same path for email.
